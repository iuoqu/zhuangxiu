...
def draw():
    ...
    notes = [
        ...
        '各房间门至疏散门 11.8~20.3 m（最不利为茶水区 20.3 m），室内任一点至本房间门 ≤ 4.9 m。'
        ...
        f'7. 第 3 条工位带在东端让出 2 列（3.0 × 2.5 m）作打印 / 储物 / 电话亭 ×2，'
        f'这也是本方案工位数落在 {nf.seats} 而不是 54 的原因。',
        '8. 会议室按长条桌反算：端部净距 1200、侧向净距 1200、沿桌长每人 750。'
        '大会议室 7.45 × 4.20 m（比例 1.77:1）放 5050 × 1800 长条桌，6+6+2 = 14 人；'
        '中会议室 3.95 × 6.50 m 放 4100 × 1500 长条桌，5+5+2 = 12 人。'
        '对照 3 楼实测：大会议室 8.40 × 5.70 m = 47.9 ㎡、桌 5500 × 1450、7+7+2 = 16 人；'
        '中会议室 4.02 × 5.15 m = 20.7 ㎡、8 人。',
    ]
