...
def draw():
    ...
    py = N_ZONE[1] + HEAD/2
    px = [(11800, 20450), (11800, 19599), (ax, 19599), (ax, SPINE_Y[0]+900), ((cx[0]+cx[1])/2, SPINE_Y[0]+900),
    ...
    s.circ(11800, 20450, 220, C['demo'])
    s.txt(11550, 20570, '最不利房间', 290, C['demo'], anchor='end', weight='600')
    ...
    notes = [
        ...
        '5. 茶水区紧贴保留的备餐间 / 茶水间（既有给排水点位），可就近接水，避免长距离排水；'
        '打通 X=12751 处一道墙即可与保留茶水间 23 ㎡ 合并为约 37 ㎡ 的完整茶水区，并占据南向采光段。',
        '6. 第 3 条工位带在东端让出 2 列（3.0 × 2.5 m）作打印 / 储物 / 电话亭 ×2，'
