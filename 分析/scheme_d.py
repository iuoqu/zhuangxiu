...
CUT = SY0 + 2450                          # 洽谈带南边线 = 14299
SPUR = (7400, SY0, 8800, SY1)             # 纵向支通道 1400（东移，让西块够长放长条桌）
W0, W1 = S_ZONE[0], SPUR[0]               # 西块 −50 → 7400  (7450)
E0, E1 = SPUR[2], S_ZONE[2]               # 东块 8800 → 12751 (3951)

# 4 间洽谈贴南区主通道一字排开（门直接开到主通道）；
# 大会议室 / 茶水区在西块南侧、中会议室在东块，门开到纵向支通道。
ROOMS = [
    # (x0, y0, x1, y1, 名称, 说明, 门在哪一侧)
    (W0,    SY0, 2367,  CUT,   '洽谈间 A', 'Ø900 圆桌 4 人', 'N'),
    (2467,  SY0, 4884,  CUT,   '洽谈间 B', 'Ø900 圆桌 4 人', 'N'),
    (4984,  SY0, W1,    CUT,   '洽谈间 C', 'Ø900 圆桌 4 人', 'N'),
    (E0,    SY0, E1,    CUT,   '洽谈间 D', '1600×900 桌 6 人', 'N'),
    (W0, 14399,  W1,    18599, '大会议室', '长条桌 5050×1800　14 人', 'E'),
    (W0, 18699,  W1,    SY1,   '茶水区',   '吧台 ＋ 高桌', 'E'),
    (E0, 14399,  E1,    SY1,   '中会议室', '长条桌 4100×1500　12 人', 'W'),
]
